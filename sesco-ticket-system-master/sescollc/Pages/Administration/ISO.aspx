...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderMaim" runat="server">
    <asp:ScriptManagerProxy runat="server">
        <Scripts>
            ...
            <asp:ScriptReference Path="ISO.js" />
        </Scripts>
    </asp:ScriptManagerProxy>

    <div class="row">
         <h1 class="page-header">Add New  ISO</h1>

    <div class="panel panel-default">
     <div class="panel-heading">
    <div class="form-group">
         <label>ISO Name <span class="ms-accentText">*</span></label>
     ...
     <div class="form-group">
        <button type="button" class="btn btn-primary btn-sm" onclick="AddISO()">Add ISO</button>
     </div>
    </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-12" >
             <h1 class="page-header">ISO List</h1>
