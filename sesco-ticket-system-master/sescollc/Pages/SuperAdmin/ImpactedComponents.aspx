...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderMaim" runat="server">
    <asp:ScriptManagerProxy runat="server">
        <Scripts>
            ...
            <asp:ScriptReference Path="ImpactedComponents.js" />
        </Scripts>
    </asp:ScriptManagerProxy>

    <div class="row">
         <h1 class="page-header">Add New  Component</h1>

    <div class="panel panel-default">
     <div class="panel-heading">
    <div class="form-group">
         <label>Component Name <span class="ms-accentText">*</span></label>
        <SharePoint:InputFormTextBox runat="server" ID="ISOName" ClientIDMode="Static" MaxLength="100" CssClass="form-control" required="required" />
    </div>

     <div class="form-group">
        <button type="button" class="btn btn-primary btn-sm" onclick="AddISO()">Add Component</button>
     </div>
    </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-12" >
             <h1 class="page-header">Impacted Components List</h1>
        ...
        <br />
        <button type="button" class="btn btn-primary btn-md" onclick="javascript:UpdateRanking()">Update Ranking</button>
        <br />
        <br />
    </div>
