...
function GetTickets(clause) {
    ...
    // let url = _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getbytitle('SupportTickets')/items?$orderby=ID desc&$top=3000&$expand=Team/ID,Submtter/Id,Submtter/Title,Author/Id,SupportAgent/Id&$select=*,Team/ID,SupportAgent/Title,Author/Title,Submtter/Id,Submtter/Title&$filter=" + clause;
    let url = _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getbytitle('SupportTickets')/items?$orderby=ID desc&$top=3000&$expand=Team/ID,Submtter/Id,Submtter/Title,Author/Id,SupportAgent/Id&$select=*,Team/ID,SupportAgent/Title,Author/Title,Submtter/Id,Submtter/Title";
...
function ShowData(data) {
    ...
    jq('#dataTable').DataTable({
        initComplete: function (settings, json) {
            ...
            jq('#dataTable tbody td.details-control3').click(function () {
                let tr = jq(this).closest('tr');
                let id = tr.find('td').eq(3).text();
                DeleteRequest(id, jq(this));
            });
