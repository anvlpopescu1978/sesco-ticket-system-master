...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderMaim" runat="server">
    <asp:ScriptManagerProxy runat="server">
        <Scripts>
            ...
            <asp:ScriptReference Path="ClosureReasons.js" />
        </Scripts>
    </asp:ScriptManagerProxy>

    <div class="row">
         <h1 class="page-header">Add New Closure Reason</h1>

    <div class="panel panel-default">
     <div class="panel-heading">
    <div class="form-group">
         <label>Closure Reason <span class="ms-accentText">*</span></label>
        <SharePoint:InputFormTextBox runat="server" ID="ClosureReason" ClientIDMode="Static" MaxLength="100" CssClass="form-control" required="required" />
    </div>

     <div class="form-group">
       <label>Request Type <span class="ms-accentText">*</span></label>
         <SharePoint:DVListBox runat="server" ID="RequestType" SelectionMode="Multiple" ClientIDMode="Static">

         </SharePoint:DVListBox>
     </div>

     <div class="form-group">
        <button type="button" class="btn btn-primary btn-sm" onclick="AddClosureReason()">Add Reason</button>
     </div>
    </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-12" >
             <h1 class="page-header">Closure Reasons List</h1>
         ...
         <br />
        <button type="button" class="btn btn-primary btn-md" onclick="javascript:UpdateReasons()">Update Closure Reasons List</button>
        <br />
        <br />
    </div>
