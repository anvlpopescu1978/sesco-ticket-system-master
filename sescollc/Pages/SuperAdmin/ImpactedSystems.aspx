...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderMaim" runat="server">
    <asp:ScriptManagerProxy runat="server">
        <Scripts>
            ...
            <asp:ScriptReference Path="ImpactedSystems.js" />
        </Scripts>
    ...
    <div class="form-group">
         <label>System Name <span class="ms-accentText">*</span></label>
     ...
     <div class="form-group">
        <button type="button" class="btn btn-primary btn-sm" onclick="AddISO()">Add System</button>
     </div>
    </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-12" >
             <h1 class="page-header">Impacted Systems List</h1>
