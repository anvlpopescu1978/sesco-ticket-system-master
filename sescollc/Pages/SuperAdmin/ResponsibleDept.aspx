...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderMaim" runat="server">
    <asp:ScriptManagerProxy runat="server">
        <Scripts>
            ...
            <asp:ScriptReference Path="ResponsibleDept.js" />
        </Scripts>
    ...
    <div class="form-group">
         <label>Department Name <span class="ms-accentText">*</span></label>
        <SharePoint:InputFormTextBox runat="server" ID="ResponsibleDepartment" ClientIDMode="Static" MaxLength="100" CssClass="form-control" required="required" />
    </div>

     <div class="form-group">
        <button type="button" class="btn btn-primary btn-sm" onclick="addDept()">Add Department</button>
     </div>
    </div>
    </div>
</div>
