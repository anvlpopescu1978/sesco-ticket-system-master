    ...
    <div class="form-group">
            ...
            <SharePoint:DVDropDownList runat="server" SelectedValue="" CssClass="form-control" ClientIDMode="Static" ID="AssignedTo" DataSourceID="DSUsers" DataTextField="UserName1" DataValueField="UserLogin" required="required">
                <asp:ListItem Text="..." Value="" />
                     ...
                     <!--I ADDED THIS - CHANGED TO MULTISELECT -->
     <div class="form-group">
            <label>Responisble Department</label>
            <SharePoint:DVListBox runat="server" SelectionMode="Single" SelectedValue="" CssClass="form-control" ClientIDMode="Static" ID="ResponsibleDepartment" DataSourceID="DSResponsibleDept" DataTextField="ResponsibleDepartment" DataValueField="ResponsibleDepartment" >
